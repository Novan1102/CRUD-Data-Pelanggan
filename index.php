<?php
  ...
  #Check if form submitted // Cek apakah formulir telah dikirimkan (method POST)
  if($_SERVER["REQUEST_METHOD"]=='POST'){
    // Mendapatkan nilai dari formulir dan melindunginya dari injeksi SQL
    ...
    // Query SQL untuk menambahkan data pengguna ke dalam tabel
    $sql="INSERT INTO users_data (NAME,EMAIL,CONTACT) VALUES ('{$name}','{$email}','{$contact}')";
    // Eksekusi query dan berikan pesan kilat sesuai dengan hasilnya
    if($con->query($sql)){
      #set flash message
  ...
  #select all records from the table // Memilih semua rekaman dari tabel users_data
  $data=[];
